...
<p>Что нужно было сделать:<p>
<ol>
  <li>Построить таблицу с клиентским Retention.
    На основании Retention рассчитать лайфтайм с помощью метода усреднённых прямоугольников для каждой когорты</li>
  <li>Рассчитать LTV с помощью усреднённых костов для каждой когорты
      Сделать выводы относительно хороших и плохих когорт с точки зрения LTV.</li>
</ol>
